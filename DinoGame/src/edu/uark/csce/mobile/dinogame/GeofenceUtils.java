...
public final class GeofenceUtils {
     ...
     */
    public static final String APPTAG = "Dino Game";

    // Intent actions
    public static final String ACTION_CONNECTION_ERROR =
            "edu.uark.csce.mobile.dinogame.ACTION_CONNECTION_ERROR";

    public static final String ACTION_CONNECTION_SUCCESS =
            "edu.uark.csce.mobile.dinogame.ACTION_CONNECTION_SUCCESS";

    public static final String ACTION_GEOFENCES_ADDED =
            "edu.uark.csce.mobile.dinogame.ACTION_GEOFENCES_ADDED";

    public static final String ACTION_GEOFENCES_REMOVED =
            "edu.uark.csce.mobile.dinogame.ACTION_GEOFENCES_DELETED";

    public static final String ACTION_GEOFENCE_ERROR =
            "edu.uark.csce.mobile.dinogame.ACTION_GEOFENCES_ERROR";

    public static final String ACTION_GEOFENCE_TRANSITION =
            "edu.uark.csce.mobile.dinogame.ACTION_GEOFENCE_TRANSITION";

    public static final String ACTION_GEOFENCE_TRANSITION_ERROR =
                    "edu.uark.csce.mobile.dinogame.ACTION_GEOFENCE_TRANSITION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
                    "edu.uark.csce.mobile.dinogame.CATEGORY_LOCATION_SERVICES";
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "edu.uark.csce.mobile.dinogame.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "edu.uark.csce.mobile.dinogame.EXTRA_CONNECTION_ERROR_MESSAGE";
     ...
     */
    public static final String KEY_GEOFENCE_ID_ARRAY = "edu.uark.csce.mobile.dinogame.KEY_GEOFENCE_ID_ARRAY";
    
    public static final String KEY_LAST_GEOFENCE_ID = "edu.uark.csce.mobile.dinogame.KEY_LAST_GEOFENCE_ID";
    
    public static final String KEY_LATITUDE = "edu.uark.csce.mobile.dinogame.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "edu.uark.csce.mobile.dinogame.KEY_LONGITUDE";
    ...
    public static final String KEY_PREFIX =
            "edu.uark.csce.mobile.dinogame.KEY";
