...
public class DeleteDinoDialogFragment extends DialogFragment {
    ...
    public interface DeleteDinoDialogListener {
        public void onDialogPositiveClick(DialogFragment dialog);
        public void onDialogNegativeClick(DialogFragment dialog);
    }
    
    // Use this instance of the interface to deliver action events
    DeleteDinoDialogListener mListener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mListener = (DeleteDinoDialogListener) activity;
        ...
        builder.setTitle(title)
               ...
               .setPositiveButton("Do it.", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                       ...
                       mListener.onDialogPositiveClick(DeleteDinoDialogFragment.this);
                   }
               })
               .setNegativeButton("Oh no stop!", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                       // Send the negative button event back to the host activity
                       mListener.onDialogNegativeClick(DeleteDinoDialogFragment.this);
                   }
               });
